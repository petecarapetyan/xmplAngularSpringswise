...
type CarFormGroupContent = {
  ...
  motorSize: FormControl<ICar['motorSize']>;
  modelName: FormControl<ICar['modelName']>;
  wheelSize: FormControl<ICar['wheelSize']>;
  transmission: FormControl<ICar['transmission']>;
  color: FormControl<ICar['color']>;
  yearOf: FormControl<ICar['yearOf']>;
...
export class CarFormService {
  createCarFormGroup(car: CarFormGroupInput = { id: null }): CarFormGroup {
    ...
    return new FormGroup<CarFormGroupContent>({
      ...
      motorSize: new FormControl(carRawValue.motorSize),
      modelName: new FormControl(carRawValue.modelName),
      wheelSize: new FormControl(carRawValue.wheelSize),
      transmission: new FormControl(carRawValue.transmission),
      color: new FormControl(carRawValue.color),
      yearOf: new FormControl(carRawValue.yearOf),
